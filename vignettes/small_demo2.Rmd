...
p1 <- ggplot(pdat, aes(x = cpg, y = meth_level, color = geno)) +
  ...
  scale_color_manual(values = c("darkblue", "darkorange", "limegreen")) +
...
Notice that the effect estimates with (95%) credible bands outside
zero predict very accurately the affected CpG sites.
