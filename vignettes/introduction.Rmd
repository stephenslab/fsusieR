...
```
So the underlying causal variants are variant 250 and variant 750. The plot above shows the functional effect of the two variants. Below, we generate the  observed curves (effect +noise)
