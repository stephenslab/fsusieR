...
See how the estimated function recover the true underlying effect.

```{r}
plot(fit$outing_grid, fit$fitted_func[[1]] , col="blue", type="l")
lines(fit$outing_grid, fit$cred_band[[1]][1,] , col="blue",lty=2)
lines(fit$outing_grid, fit$cred_band[[1]][2,] , col="blue",lty=2)
lines(f2)
