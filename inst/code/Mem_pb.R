...
f1 <- simu_IBSS_per_level(lev_res=10, alpha=1, prop_decay =.5)

f1_obs<- c(f1$sim_func, f1$sim_func[1:180],f1$sim_func)
...
Bhat <- matrix(rnorm(P*2^11), ncol=P)
Shat <- matrix(runif(P*2^11), ncol=P)
temp <- list(Bhat=Bhat, Shat=Shat)
