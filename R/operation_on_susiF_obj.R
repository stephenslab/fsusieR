...
#
get_ER2 = function (  Y, X, susiF.obj) {
...
#' \item{if l not missng}   {return effect specific posterior}
...
get_post_F2 <- function(susiF.obj)
{
...
#' @return susiF object
#' @export
update_KL <- function    (susiF.obj, l,  ...)
  UseMethod("update_KL")
...
update_KL.susiF <- function(susiF.obj,l)
{
...
loglik_SFR_post.susiF <- function(susiF.obj, l,Y,X){
    ...
    t = nrow(Y)
    s2 <- susiF.obj$sigma2
    return(-0.5*n*t*log(2*pi*s2) - 0.5/s2*(sum(Y*Y)
